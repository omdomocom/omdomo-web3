      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 w-80 z-50 rounded-2xl border border-slate-700/50 bg-slate-950/95 backdrop-blur-xl shadow-2xl shadow-black/50 overflow-hidden"
          >
            {/* Header */}
            ...
            {/* Footer */}
            {notifs.length > 0 && (
              <div className="px-4 py-2.5 bg-slate-900/40 text-center">
